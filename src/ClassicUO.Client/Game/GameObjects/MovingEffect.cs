...
{
    /// <summary>
    /// Legacy moving effect for traditional UO spells and arrows.
    /// Uses frame-based animation with entity tracking.
    /// For server-synchronized free-aim projectiles, use TrackedProjectileEffect instead.
    /// </summary>
